INSERT INTO public.config ("key",value,created_at,updated_at,description) VALUES
	 ('UTC_PLUS_5','timezone(timedelta(hours=5))','2025-12-24 16:15:12.270',NULL,'временная зона'),
	 ('EDIT_REQUEST_LIMIT','4','2025-12-24 16:15:12.272',NULL,'оганичение на кол-во редактирований профиля в сутки'),
	 ('SIMILARITY_THRESHOLD','0.4','2025-12-24 16:16:45.826',NULL,'граница схожисти при поиске новых сервисов через gpt'),
	 ('ADMIN_IDS','{988269770}','2025-12-24 16:16:45.828',NULL,'список админов'),
